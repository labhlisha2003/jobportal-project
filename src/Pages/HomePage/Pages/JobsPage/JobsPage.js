  ...
  return (
    <div className="Container">
      ...
      <div className="jobPageInputContainer">
        ...
        <CustomButton backgroundColor={"var(--baseColor)"} title={"Search Jobs"} color={"white"} />
      </div>
      ...
      <div className="BaseContainerrrr">
        <section className="firstContainer">
          ...
          <div className="secondContainer">
            ...
            <div style={{backgroundColor: "red", display: "flex", alignItems: "center", justifyContent: "flex-end", marginRight: "40px"
            }}>
          ...
          <div className="thirdContainer">
            ...
            <div style={{backgroundColor:"blueviolet",display:"flex", alignItems: "center",justifyContent: "flex-end", marginRight:"40px"}}>
